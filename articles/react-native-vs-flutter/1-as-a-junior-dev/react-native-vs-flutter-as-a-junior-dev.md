...
- [1. Flutter Wins: Out-of-the-box DevX features and simple toolchain](#1-flutter-wins-out-of-the-box-devx-features-and-simple-toolchain)
  - [1.1. Flutter has convenient built-in systems](#11-flutter-has-convenient-built-in-systems)
  - [1.2. Flutter’s VSCode extension saves a lot of time](#12-flutters-vscode-extension-saves-a-lot-of-time)
  - [1.3. Diagnosing a bug in Flutter can be easier](#13-diagnosing-a-bug-in-flutter-can-be-easier)
  - [1.4. Type guards are not needed in Flutter](#14-type-guards-are-not-needed-in-flutter)
  - [1.5. Linting and formatting works out of the box with Flutter](#15-linting-and-formatting-works-out-of-the-box-with-flutter)
- [2. React Native Wins: Large community, resources and opportunities](#2-react-native-wins-large-community-resources-and-opportunities)
  - [2.1. Resolving a bug in React Native can be easier](#21-resolving-a-bug-in-react-native-can-be-easier)
  - [2.2. There are more JS packages than Dart packages](#22-there-are-more-js-packages-than-dart-packages)
  - [2.3. More opportunities with JS and React](#23-more-opportunities-with-js-and-react)
- [3. Other considerations](#3-other-considerations)
  - [3.1. React Native uses functional programming by convention, Flutter uses object-oriented programming by design](#31-react-native-uses-functional-programming-by-convention-flutter-uses-object-oriented-programming-by-design)
  - [3.2. Everything is a component/widget in Flutter, while React Native uses components and stylesheets](#32-everything-is-a-componentwidget-in-flutter-while-react-native-uses-components-and-stylesheets)
...
## 1. Flutter Wins: Out-of-the-box DevX features and simple toolchain
### 1.1. Flutter has convenient built-in systems
...
### 1.2. Flutter’s VSCode extension saves a lot of time
...
###  1.3. Diagnosing a bug in Flutter can be easier
...
<figure>
<img src="image-8.png" alt="my alt text"/>
...
###  1.4. Type guards are not needed in Flutter


<figure>
<img src="image-9.png" alt="my alt text"/>
...
## 2. React Native Wins: Large community, resources and opportunities
### 2.1. Resolving a bug in React Native can be easier
...
### 2.2. There are more JS packages than Dart packages

When it comes to the availability of third-party packages, React Native and Flutter present different ecosystems. There are over 1.3 million packages on npm alone, while Flutter’s pub.dev only has 33 thousand packages. I’ve almost always found the React Native package I need on the first Google search, while there have been occasions where I had to write my own Flutter package.


<figure>
<img src="image-11.png" alt="my alt text"/>
<figcaption style="text-align: center; font-size: smaller;">The number of Flutter packages pales in comparison to React Native — I had to write my own package to implement dynamic markers on Google Maps.
</figcaption>
</figure>

### 2.3. More opportunities with JS and React
...
###  3.1. React Native uses functional programming by convention, Flutter uses object-oriented programming by design
...
<figure>
<img src="image-12.png" alt="my alt text"/>
...
### 3.2. Everything is a component/widget in Flutter, while React Native uses components and stylesheets



<figure>
<img src="image-13.png" alt="my alt text"/>
